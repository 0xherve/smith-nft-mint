...
The Metadata Object is implemented in the `metadata.ts` file. 
...
There are 3 major challenges regarding the trading of minted NFTs, namely:

1. In order to sell the minted NFTs, I need to contact people and inquire about their interest in buying them.

2. As I want to buy different Collectibles, I have to reach out to other people and ask if they have NFTs for me to buy.
...
- Wallet used: EmiNAMemxkFNcq252pccGk37QytVNXNRsV48KcRFPYs5
- NFT image: https://devnet.irys.xyz/bRgskzLd6GmVMxgdST7jyszb2cDrdmdfCzYSjVTjszH
- Metadata: https://gateway.irys.xyz/DRVziYumnp7mfQp2ntievqUBnoZFPW9L6hpA9pxauTGL
- Metaplex Explorer Link: https://core.metaplex.com/explorer/5o6Md2YoanW4euckiLE1ABXbMdbSXrUcUJSkA8z1DHfR?env=devnet
